# Generated by Django 3.2.8 on 2021-10-31 04:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=255)),
                ('tipo', models.CharField(choices=[('pecho', 'Pecho'), ('hombro', 'Hombro'), ('triceps', 'Triceps'), ('servicios varios', 'Servicios varios'), ('recepcion', 'Recepcion')], max_length=255)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, to='gym.EquipoDeEntrenamiento'),
        ),
        migrations.AddField(
            model_name='clase',
            name='rutina',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gym.rutina'),
        ),
        migrations.AddField(
            model_name='clase',
            name='zona',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='gym.zona'),
        ),
    ]
